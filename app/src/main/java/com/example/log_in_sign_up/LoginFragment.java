...
public class LoginFragment extends Fragment {
    ...
    public void onStart() {
        ...
        // ***** MOVE THIS BLOCK INSIDE onStart() *****
        btnLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) { // Note: It's better practice to use a lowercase 'v' for the variable name
                // Data validation
                ...
                fbs.getAuth().signInWithEmailAndPassword(username, password).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                    ...
                    public void onSuccess(AuthResult authResult) {
                        // There is another error here, 'task' is not defined.
